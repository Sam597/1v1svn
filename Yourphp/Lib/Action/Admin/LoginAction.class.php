...
//            $this->error(L('Login_error_count'));
        ...
        if (false === $authInfo) {
            ...
            //非超级管理员增加校区域校区标示
            $_SESSION['siteid'] = $authInfo['groupid'] != 1 ? $authInfo['siteid'] : 0;
            $_SESSION['schoolid'] = $authInfo['groupid'] != 1 ? $authInfo['schoolid'] : 0;
            $_SESSION['areaid'] = $authInfo['groupid'] != 1 ? $authInfo['areaid'] : 0;
